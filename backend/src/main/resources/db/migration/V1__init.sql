...
INSERT INTO users (id, email, password_hash, role) VALUES
  ('00000000-0000-0000-0000-000000000001', 'admin@carrent.ru', '$2a$10$XptfskLsT9u/OL0bOuLBiOGRqYBTpgQFoGHOWbHLCjZ5kE9CgxfGi', 'ADMIN'),
  ('00000000-0000-0000-0000-000000000002', 'manager@carrent.ru', '$2a$10$XptfskLsT9u/OL0bOuLBiOGRqYBTpgQFoGHOWbHLCjZ5kE9CgxfGi', 'MANAGER'),
  ('00000000-0000-0000-0000-000000000003', 'client@carrent.ru', '$2a$10$XptfskLsT9u/OL0bOuLBiOGRqYBTpgQFoGHOWbHLCjZ5kE9CgxfGi', 'CLIENT');

INSERT INTO client_profiles (user_id, is_verified) VALUES
  ('00000000-0000-0000-0000-000000000003', true);

INSERT INTO cars (vin, license_plate, model_name, current_mileage, car_class, base_daily_rate, status) VALUES
  ('WVWZZZ1JZXW000001', 'А123БВ26', 'Volkswagen Polo', 25000, 'ECONOMY', 2500.00, 'AVAILABLE'),
  ('XTA21099090000001', 'В456ГД26', 'Lada Vesta', 18000, 'ECONOMY', 2000.00, 'AVAILABLE'),
  ('Z8NFNAF35JM000001', 'Е789ЖЗ26', 'Kia Rio', 31000, 'ECONOMY', 2800.00, 'AVAILABLE'),
  ('WBAPH71000E000001', 'И012КЛ26', 'BMW 3 Series', 45000, 'BUSINESS', 8000.00, 'AVAILABLE'),
  ('WAUZZZ4G0DN000001', 'М345НО26', 'Audi A4', 38000, 'BUSINESS', 7500.00, 'AVAILABLE');
